...
20 settembre 2026 — Diagnosi crawl su main 0fe67dc: otto URL pubblici 200; home, filtri posizioni, indice statico, Dottorati e Postdoc con H1, canonical autoreferenziale e index/follow nell’HTML ricevuto senza JavaScript. Home collega direttamente indice e landing; prima pagina indice contiene 30 link scheda e paginazione fino a 20. Sitemap valida: 610 URL uniche, tutte le cinque pagine core presenti. robots consente i percorsi pubblici. PR #19 verificata: quattro link disciplinari PhD ancora presenti. Nessun blocco riprodotto nel campione; non prova accesso Googlebot o causa del rinvio di scansione. Export GSC utente al 14 settembre: 1 indicizzata, 685 rilevate non indicizzate, 2 redirect, 0 5xx. Screenshot 19 settembre: Dottorati rilevata via sitemap, non indicizzata. Richiesta di indicizzazione confermata dall’utente; esito live test non ricevuto.

19 settembre 2026 — Il sync ordinario del 18 settembre ha applicato la tassonomia più conservativa: sui 30 PhD ancora aperti alla data della build, 18 hanno un'area specifica coerente e 12 restano «Altro / interdisciplinare». La landing Dottorati ora può esporre quattro percorsi specifici con conteggi e filtri esistenti; l'area incerta resta esclusa. Nessuna nuova pagina o URL canonica.

18 settembre 2026 — Il sync successivo alla PR #17 ha applicato la nuova classificazione a 172 PhD aperti, ma il controllo campione ha trovato falsi positivi residui: `design` tecnico veniva letto come area progettuale, `management` come economia e `neuromorphic` come neuroscienze. La tassonomia non è ancora adatta a collegamenti pubblici nella landing Dottorati. La correzione proposta dà priorità a settore/titolo, richiede un unico segnale coerente nel testo descrittivo e preferisce «Altro / interdisciplinare» nei bandi multi-area.

17 settembre 2026 — La proposta di aggiungere percorsi disciplinari alla landing Dottorati ha scoperto un difetto più rilevante: 145/172 PhD aperti erano assegnati all'area umanistica. Il normalizzatore classificava il boilerplate «lettera di motivazione» tramite il frammento generico `letter` e non considerava il titolo quando esisteva una descrizione. Correzione: titolo incluso tra le evidenze, keyword ristretta a letteratura/literature e varianti con trattino per machine learning/data science. Simulazione conservativa sul dataset corrente: 150/172 discipline cambiano; 105 diventano «Altro / interdisciplinare» anziché ricevere una categoria dedotta senza evidenza e 67 ricevono una categoria specifica supportata dal testo. Nessuna cache modificata manualmente: effetto atteso al prossimo sync ordinario riuscito.
...
13 settembre 2026 — Sessione aggiuntiva — Corretto il troncamento a 180 caratteri dei requisiti: due schede attive per data/archivio (147663 Genova e 151146 Politecnico di Milano) perdevano alternative di ammissione e requisito sulle pubblicazioni. Testi integrali del campo MUR «Requisiti specifici in italiano» verificati via HTTP 200 il 13 settembre e riportati senza parafrasi. Normalizzatore corretto per preservare i testi nei prossimi sync; aggiornati subito solo i due campi requirements della cache. Nessuna modifica a date, URL, stato o altri record.

13 settembre 2026 — Riesame campione indicizzazione: main c166625, nessuna PR aperta, deploy Pages 34690297420 riuscito. GSC Wizard ha rifiutato query_search_analytics con payment_required (trial terminato oppure abbonamento assente); nessuna ispezione Google eseguita. HTTP diretto: home, indice, Dottorati, Postdoc, MSCA e tre Postdoc 314470/316445/316620 rispondono 200 con canonical corrette; titoli Postdoc specifici confermati. Le quattro landing espongono index/follow. La scheda /positions/mur-doctorates-296467/ risponde 200 ma è noindex/follow: deadline 6 settembre e archivedAt 8 settembre nel dataset. Trattarla come controllo archivio, non come pagina attiva da indicizzare. Sitemap XML valido, 694 URL uniche; home e quattro landing presenti. Robots consente la scansione pubblica, favicon 200. Nessuna prova nuova di indicizzazione o di crescita.

12 settembre 2026 — Verifica post-deploy PR #10 completata. Il sync MUR 34585571045, eseguito sul merge a8b9ae0, e il deploy Pages 34585994870 sono riusciti; ultimo deploy 34595370118 riuscito. Le schede campione 314470, 316445 e 316620 rispondono 200, espongono titolo specifico e canonical corretta. Nel dataset main bf0bfee i Postdoc con titolo generico sono 29/108, tutti con scadenza precedente al 12 settembre: rispetto alla baseline pre-sync, generici totali 97→29 e con scadenza non trascorsa 68→0. Non è prova di disponibilità né di crescita del traffico.
