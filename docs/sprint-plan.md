...
- MUR/Cineca positions now have a daily GitHub Actions refresh that updates `lib/generated/mur-positions.json` and triggers Vercel redeploys when data changes.
